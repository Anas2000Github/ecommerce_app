              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                      itemCount: controller.wristwatchModel.length,
                            ...
                            child: Row(
                              children: [
                                Container(
                                    width: Get.width *.3,
                                    child: Image.network(
                                      controller.wristwatchModel[index].image.toString(),
                                      fit: BoxFit.fill,
                                    )),
                                Container(
                                  width: Get.width*.6,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      CustomText(
                                        text: controller.wristwatchModel[index].name.toString().tr,
                                        fontsize: 21,
                                      ),
                                      5.height,
                                      CustomText(
                                        ...
                                        text:
                                        '\$${controller.wristwatchModel[index].price}',
                                        fontsize: 21,
                                      ),
                                    ],
                                  ),
