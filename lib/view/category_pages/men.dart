              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                      itemCount: controller.shoesModel.length,
                            ...
                            child: Row(
                              children: [
                                Container(
                                    width: Get.width *.3,
                                    child: Image.network(
                                      controller.shoesModel[index].image.toString(),
                                      fit: BoxFit.fill,
                                    )),
                                Container(
                                  width: Get.width*.6,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      CustomText(
                                        text: controller.shoesModel[index].name.toString().tr,
                                        fontsize: 21,
                                      ),
                                      5.height,
                                      CustomText(
                                        ...
                                        text:
                                        '\$${controller.shoesModel[index].price}',
                                        fontsize: 21,
                                      ),
                                    ],
                                  ),
